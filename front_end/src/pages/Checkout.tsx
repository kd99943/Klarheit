...
export function Checkout() {
  ...
  const lensTotal = useMemo(() => LENS_PACKAGE.reduce((total, item) => total + item.price, 0), []);
    ...
    <div className="flex-1 w-full bg-surface-offwhite py-10 lg:py-16 px-5 sm:px-8">
      <form onSubmit={handleSubmit} className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        <div className="lg:col-span-7 flex flex-col gap-10">
          ...
          <SectionCard title="Prescription Details" eyebrow="Step 02" description="All values remain mapped to the current backend order contract.">
          ...
          {successMessage ? <div className="border border-emerald-200 bg-emerald-50 text-emerald-700 px-6 py-4 rounded-xl text-sm">{successMessage}</div> : null}
        </div>
