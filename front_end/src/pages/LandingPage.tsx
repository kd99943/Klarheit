        ...
        <div className="max-w-[1440px] mx-auto px-8 lg:px-16 relative z-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 border border-white/10 p-8 xl:p-10 backdrop-blur-xl hover:bg-white/10 transition-colors duration-500 rounded-lg">
              ...
              <h3 className="text-xl md:text-2xl font-display text-white mb-4 tracking-tight">{t("optics.card1.title")}</h3>
              <p className="text-sm text-slate-300 font-light leading-relaxed mb-8">
                {t("optics.card1.description")}
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="text-[9px] border border-white/20 px-3 py-1.5 rounded uppercase tracking-widest text-slate-300">{t("optics.card1.tag1")}</span>
                <span className="text-[9px] border border-white/20 px-3 py-1.5 rounded uppercase tracking-widest text-slate-300">{t("optics.card1.tag2")}</span>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 p-8 xl:p-10 backdrop-blur-xl hover:bg-white/10 transition-colors duration-500 rounded-lg">
              ...
              <h3 className="text-xl md:text-2xl font-display text-white mb-4 tracking-tight">{t("optics.card2.title")}</h3>
              <p className="text-sm text-slate-300 font-light leading-relaxed mb-8">
                {t("optics.card2.description")}
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="text-[9px] border border-white/20 px-3 py-1.5 rounded uppercase tracking-widest text-slate-300">{t("optics.card2.tag1")}</span>
                <span className="text-[9px] border border-white/20 px-3 py-1.5 rounded uppercase tracking-widest text-slate-300">{t("optics.card2.tag2")}</span>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 p-8 xl:p-10 backdrop-blur-xl hover:bg-white/10 transition-colors duration-500 rounded-lg">
              ...
              <h3 className="text-xl md:text-2xl font-display text-white mb-4 tracking-tight">{t("optics.card3.title")}</h3>
              <p className="text-sm text-slate-300 font-light leading-relaxed mb-8">
                {t("optics.card3.description")}
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="text-[9px] border border-white/20 px-3 py-1.5 rounded uppercase tracking-widest text-slate-300">{t("optics.card3.tag1")}</span>
                <span className="text-[9px] border border-white/20 px-3 py-1.5 rounded uppercase tracking-widest text-slate-300">{t("optics.card3.tag2")}</span>
              </div>
            </div>
          </div>
        </div>
